...
namespace BossRush
{
    ...
    public static class LocalizationInjector
    {
        ...
        public static void InjectZombieModeLocalization()
        {
            ...
            InjectZombieModeString("BossRush_ZombieMode_CashPrompt_Body", "兑换比例：100 现金 = 1 净化点数。撤离时按 1:1 转回现金。失败/死亡全部损失。", "Rate: 100 Cash = 1 Purification Point. On extraction, refunded 1:1 as Cash. All lost on failure or death.");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Starter_Melee_Desc", "随机近战武器 + 医疗 + 食物饮料。无护甲、无现金。", "Random melee weapon + medical + food/drink. No armor, no cash.");
            InjectZombieModeString("BossRush_ZombieMode_Starter_Gunner", "枪械突围", "Gunner");
            InjectZombieModeString("BossRush_ZombieMode_Starter_Gunner_Desc", "随机枪械 + 匹配弹药 + 1000 发低级同口径弹药。", "Random gun + matched ammo + 1000 low-tier same-caliber ammo.");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Notify_StorageFull", "仓储空间不足，无法转移所有装备。", "Storage is full; cannot transfer all gear.");
            InjectZombieModeString("BossRush_ZombieMode_Notify_HasBoundItems", "任务/绑定物品阻止入场。", "Quest/bound items prevent entering.");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Notify_ExtractionCash", "成功带出 {0} 金钱。", "Successfully extracted {0} money.");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Notify_ContractPollutionDeal", "契约完成：净化点 +{0}，污染 +{1}。", "Pact complete: Purification +{0}, Pollution +{1}.");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Reason_StorageFull", "仓储空间不足。", "Storage is full.");
            InjectZombieModeString("BossRush_ZombieMode_Reason_BlockedTaskOrBoundItems", "存在不可转移物品。", "Blocked by quest or bound items.");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Reward_Heal", "恢复生命", "Restore Health");
            InjectZombieModeString("BossRush_ZombieMode_Reward_RandomSupply", "随机补给", "Random Supply");
            InjectZombieModeString("BossRush_ZombieMode_Reward_RandomHighQualityItem", "高级补给", "High-Quality Supply");
            InjectZombieModeString("BossRush_ZombieMode_Reward_StarterReroll", "武器补充", "Weapon Refill");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Reward_TempMerchant", "召唤临时商人", "Summon Temp Merchant");
            InjectZombieModeString("BossRush_ZombieMode_Reward_TempNurse", "召唤临时护士", "Summon Temp Nurse");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Reward_ContractGearDeal", "装备契约：污染换高阶装备", "Gear Pact: Pollution for Gear");
            InjectZombieModeString("BossRush_ZombieMode_Reward_ContractHugePurification", "巨额净化契约", "Huge Purification Pact");
            InjectZombieModeString("BossRush_ZombieMode_Reward_ContractInsurance", "保险契约", "Insurance Pact");
            InjectZombieModeString("BossRush_ZombieMode_Reward_InsuranceKeepOne", "失败保险：随机保留物品", "Failure Insurance: Keep Random Items");
            InjectZombieModeString("BossRush_ZombieMode_Reward_InsuranceRandom10", "失败保险：随机保留 10%", "Failure Insurance: Keep Random 10%");
            InjectZombieModeString("BossRush_ZombieMode_Reward_InsuranceRandom20", "失败保险：随机保留 20%", "Failure Insurance: Keep Random 20%");
            InjectZombieModeString("BossRush_ZombieMode_Reward_InsuranceNearFull", "高危保险：随机保留 80%", "High-Risk Insurance: Keep Random 80%");
            InjectZombieModeString("BossRush_ZombieMode_Reward_MapEventHighValueAirdrop", "事件：高价值空投", "Event: High-Value Airdrop");
            InjectZombieModeString("BossRush_ZombieMode_Reward_MapEventEliteSquad", "事件：下波精英小队", "Event: Elite Squad Next Wave");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Npc_TempMerchant", "临时商人", "Temp Merchant");
            InjectZombieModeString("BossRush_ZombieMode_Npc_TempNurse", "临时护士", "Temp Nurse");
            InjectZombieModeString("BossRush_ZombieMode_Npc_InteractMerchant", "按 {0} 交易", "Press {0} to trade");
            InjectZombieModeString("BossRush_ZombieMode_Npc_InteractNurse", "按 {0} 接受治疗", "Press {0} to heal");

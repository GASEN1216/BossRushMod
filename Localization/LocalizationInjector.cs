...
namespace BossRush
{
    ...
    public static partial class LocalizationInjector
    {
        ...
        public static void InjectZombieModeLocalization()
        {
            ...
            InjectZombieModeString("BossRush_ZombieMode_CashPrompt_Max", "全部", "Max");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Hud_BeaconChanneling", "信标引导中 {0:0.0} 秒", "Beacon channeling {0:0.0}s");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Banner_Started", "<color=#80DBA8>击杀目标 → 选择强化 → 第 5 波 Boss 后可撤离</color>", "<color=#80DBA8>Kill targets → choose upgrades → extract after the Wave 5 Boss</color>");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Banner_WaveIncoming", "第 <color=#FFC966>{0}</color> 波尸潮来袭！", "Zombie wave <color=#FFC966>{0}</color> incoming!");
            InjectZombieModeString("BossRush_ZombieMode_Banner_WaveCleared", "第 <color=#FFC966>{0}</color> 波已肃清。", "Wave <color=#FFC966>{0}</color> cleared.");
            InjectZombieModeString("BossRush_ZombieMode_Banner_Failed", "<color=#FF9C96>末日丧尸模式失败。</color>", "<color=#FF9C96>Zombie Mode failed.</color>");
            InjectZombieModeString("BossRush_ZombieMode_Banner_BossWaveStart", "<color=#FF9C96>Boss 节点 - 第 {0} 波</color>", "<color=#FF9C96>Boss Node - Wave {0}</color>");
            InjectZombieModeString("BossRush_ZombieMode_Banner_BossWaveCleared", "<color=#FFC966>Boss 节点完成</color>", "<color=#FFC966>Boss Node Cleared</color>");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Banner_PerformanceProtect", "<color=#ABB8BF>[Dev] 性能保护已启用</color>", "<color=#ABB8BF>[Dev] Performance protect</color>");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Extraction_ExtractDesc", "站在撤离点内坚持 {0} 秒即可离开；剩余 {1} 净化点结算为现金。", "Hold inside the extraction zone for {0}s to leave; your {1} remaining Purification is paid out as cash.");
            InjectZombieModeString("BossRush_ZombieMode_Extraction_ContinueDesc", "关闭撤离点，进入下一波准备。净化点保留，但失败会全部损失。", "Close the extraction zone and prepare for the next wave. Purification is kept, but all of it is lost on failure.");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Reward_RefreshFree", "免费刷新（{0}）", "Free Refresh ({0})");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Npc_SoldOut", "售罄", "Sold Out");
            ...
            InjectZombieModeString("BossRush_ZombieMode_Npc_Merchant_Gun", "枪械", "Guns");
            InjectZombieModeString("BossRush_ZombieMode_Npc_Merchant_Melee", "近战武器", "Melee");
            InjectZombieModeString("BossRush_ZombieMode_Npc_Merchant_Accessory", "配件", "Accessories");
            InjectZombieModeString("BossRush_ZombieMode_Npc_Merchant_Bullet", "子弹", "Ammo");
            InjectZombieModeString("BossRush_ZombieMode_Npc_Merchant_Helmat", "头盔", "Helmets");
            InjectZombieModeString("BossRush_ZombieMode_Npc_Merchant_Armor", "护甲", "Armor");
            InjectZombieModeString("BossRush_ZombieMode_Npc_Merchant_Backpack", "背包", "Backpacks");
            InjectZombieModeString("BossRush_ZombieMode_Npc_Merchant_Totem", "图腾", "Totems");
            InjectZombieModeString("BossRush_ZombieMode_Npc_Merchant_Mask", "面具 / 耳机", "Masks & Headsets");

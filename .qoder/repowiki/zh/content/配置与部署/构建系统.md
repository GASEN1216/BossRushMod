...
详细结果：`docs/reports/testing/20260920_资源生产化续作交付.md`。与同日首轮网格/贴图优化分开记录，最终 SHA-256 以本轮机器报告为准。
...
具体方案和本轮数字见 `docs/reports/testing/20260920_资源生产化续作交付.md`、`docs/reports/testing/20260920_资源生产化续作交付.md`。L1/L2 之后仍由 owner 做 L3 画面和性能采样。

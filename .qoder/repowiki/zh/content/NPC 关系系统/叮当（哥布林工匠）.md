...
婚后对白由 `GoblinAffinityConfig` 取用时解析中英文，保留自称叮当、喜欢宝贝零件和亲近玩家的口气。用锤子、工具、宝贝盒与一起找螺丝替代“赠礼按钮”“系统上限”“宠爱指标”；礼物没选中就说明喜好，不要求配偶补分或证明感情。保持事件键、池条数和每日赠礼规则，新增文案仍沿用现有分类池，不另建对话引擎。

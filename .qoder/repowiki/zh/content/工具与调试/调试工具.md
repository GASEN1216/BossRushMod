...
**不可自动化项如实记 SKIP**：Mode E 撤离结算、Mode F 赏金链与撤离、标准模式胜利奖励结算
在产品代码里全是 private 且无 Debug/Validation 入口，只能靠真人走撤离点/击杀赏金 Boss。
这些项记 `SKIP` 并写明「需人工」，**不伪造 PASS，也不为了凑绿给产品代码加测试后门**。

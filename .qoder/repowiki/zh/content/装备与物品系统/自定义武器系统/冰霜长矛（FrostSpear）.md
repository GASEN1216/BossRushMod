...
## 简介
本文件为“冰霜长矛”的完整技术文档，聚焦其作为近战武器却具备“类远程控场”能力的冰冻机制。该武器通过配置将每次命中绑定为冰属性伤害，并 100% 附加原版 Cold 减速效果；同时提供寒冷防护加成，适合中距离拉扯、稳定压制与低暴击流玩法。获取途径：大冰冰（`Cname_Snow_BigIce`）额外掉落 20%（原版地图同样生效），或叮当的小店好感 5 级限量购买。
...
- 站位选择
  ...
  - 面对高机动敌人（如冲刺丧尸、骚扰丧尸），首击即冻可有效降低被接近风险。
- 时机把握

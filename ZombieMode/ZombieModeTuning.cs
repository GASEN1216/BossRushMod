...
namespace BossRush
{
    ...
    public static class ZombieModeTuning
    {
        ...
        private static class Spawn
        {
            ...
            public const float EarlyWaveMinPlayerDistance = 22f;
            public const float MidWaveMinPlayerDistance = 20f;
            public const float LateWaveMinPlayerDistance = 18f;
        ...
        public const int NormalWavePressurePerRemainingKill = Spawn.NormalWavePressurePerRemainingKill;

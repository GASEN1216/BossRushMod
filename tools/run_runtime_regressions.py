...
SCRIPT_FIXTURES = (
    ...
    "ModeHThirdReviewFixes", "ModeHMarketAudit", "ModeHItemBetLedger", "SaveFailureRecovery", "ContentThirdReviewFixes", "IntegrationThirdReviewFixes",
    ...
    "SkyIslandValidationJudges", "F3AutotestJudges", "F3MapTourJudges",
)
PROJECT_FIXTURES = {

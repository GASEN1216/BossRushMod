...
[tip] If the automatic handling fails (for example, the save cannot be written for a moment), the report page falls back to the old manual buttons. Just press one.
...
[tip] This mode asks only two things of you: who goes into the ring, and when to ring that one bell. The rest is up to them.

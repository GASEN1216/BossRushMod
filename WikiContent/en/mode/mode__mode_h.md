...
[tip] The old "Briefing / recon" button is gone: the opponents' gear and stats are now right there on the matchup, so there is nothing left to scout for.
...
[warn] Before you bet, ask yourself one question: if this money were gone, would I still want to keep playing? You can finish a whole season without betting.

...
- **Don't fight — run for extraction**
- Stand on the point for 15 seconds to extract
- Deploy fortifications to defend yourself

[warn] 3% drain per second. Hesitation = death.
...
[tip] Blood Hunt is about pacing: when to fight, when to run, when to build.

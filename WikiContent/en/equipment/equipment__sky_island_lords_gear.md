...
[tip] Only found on two of Sky Island's island lords, the Hanging-Root Huntmaster and Grain Sickle: they wear their full set every raid, and when they fall they keep **just one piece** by weight, which takes one slot in the loot box; the rest of the box is whatever they were carrying.
...
- **Rootweave Mask** (face mask): quality 5, Head Armor +1, durability 40, item ID 500090
- **Vinewoven Cuirass** (body armor): quality 5, Body Armor +3, durability 100, item ID 500091
- **Hanging-Root Quiver** (backpack): quality 5, pack capacity +6, item ID 500092
- **Greenear Straw Hat** (helmet): quality 5, Head Armor +2, durability 60, item ID 500094
...
**Rootweave pair** (any two of the Rootweave Mask / Vinewoven Cuirass / Hanging-Root Quiver worn at once):
- Every scavenging crate on the isles already has one chance to hold an **extra** island good (Homecoming Bento, Starmoss Salve, Wind-Vane Compass); wearing the pair **doubles** that chance. The crate's usual item count and quality do not change.
- Crates are filled as you approach, so what counts is what you are wearing at that moment.

**Straw-cloak pair** (any two of the Greenear Straw Hat / Straw Raincoat / Grain Sack worn at once):
- Each greenear tuft you gather yields **1 more Greenear Sheaf**; each tuft can still be gathered only once per raid.

...
The system is **off by default**. Enable "PetNest: Cub Raising and Expeditions" in the mod settings first.
...
- **Relic Egg (the lucky track)**: a low-probability direct drop of that boss's egg, placed in its loot box.
...
Drops cover the three standard difficulties, From Nothing, Faction Sandbox and Bloodhunt. Fate Echo and Zombie Mode do not drop relics.
...
- **Open PetNest** — cub roster, deployment slot, soul ledger
- **Hatch Relic Egg** — hatch an egg, or condense one from stored souls
- **Send on Expedition** — dispatch a cub to one of three disaster destinations
- **Relic Museum** — bloodline index and memorial

#### 3. Hatching
Hatching locks in three things at once, **with no rerolls**:
...
- **Shiny** — a rare material variant, purely a collector's honour, tracked separately in the index
...
| Mode | Cub allowed? |
| --- | --- |
| Three standard difficulties | Yes |
| From Nothing / Faction Sandbox / Bloodhunt | Yes |
| Fate Echo | No — the nemesis story has no room for a third party, and it would pollute the telemetry |
| Zombie Mode | No — independent lifecycle and reward system |
| Black Market Duck Cup | No — spectator mode; you do not fight |
| Base | Cubs idle around the nest (up to 3) |

### Disaster Expeditions

This is the **only** place in the system where a cub can truly die.

#### Three destinations
| Destination | Disaster | Element |
| --- | --- | --- |
| Storm Sea | Thunderstorm | Electricity |
| Acid Rain Ruins | Acid rain | Poison |
| Frozen Waste | Blizzard | Ice |
...
#### Three risk tiers
| Tier | Reward | Death rate |
| --- | --- | --- |
| Safe | Low | 0 — absolutely safe, worst case empty-handed |
| Rough | Medium | Low; the cub may return wounded |
| Desperate | High | **Real**; you are betting its life for rare output |

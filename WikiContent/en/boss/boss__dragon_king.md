...
[warn] Do not ignore the "Protect me, my child!" phase. Prioritize killing the Dragon Descendant while dodging the Dragon Lord's Prismatic Bolts every 3 seconds.
...
- The charge warning ring only appears in the last 0.3 seconds. Move sideways immediately and don't get greedy with shots
- **Phase 2 charges have a second pass**: don't stop to attack after dodging the first charge
- When Prismatic Bolts appear, run in a wide arc and don't lead tracking bolts back toward your cover

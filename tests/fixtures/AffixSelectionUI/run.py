...
def main():
    ...
    production = ('using System; using System.Reflection; using System.Collections.Generic; '
    ...
    inputs = {str(p.relative_to(ROOT)): hashlib.sha256(p.read_bytes()).hexdigest() for p in (ui, shared, lifecycle, state)}

...
REQUIRED_KEYS = [
    ...
    "BossRush_ZombieMode_Hud_Pressure",
    "BossRush_ZombieMode_Tide_Low",
    "BossRush_ZombieMode_Tide_Rising",
    "BossRush_ZombieMode_Tide_High",
    "BossRush_ZombieMode_Tide_Peak",
    "BossRush_ZombieMode_Tide_Boss",
    ...
    "BossRush_ZombieMode_Reward_NextWavePreview",
    "BossRush_ZombieMode_Reward_NextBossPreview",

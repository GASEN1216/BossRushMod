...
CHECKS = [
    ("IsProductionReadyConst",
     "ModeGAvailability.cs",
     r"public const bool IsProductionReady = (true|false)",
     "IsProductionReady 必须是 const bool"),
    ...
    ("EntryGated",
     "ModeGEntry.cs",
     r"if\s*\(!ModeGAvailability\.IsProductionReady\)",
     "TryStartModeG 路径受 IsProductionReady 门控"),

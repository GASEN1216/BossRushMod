    ...
    internal static class SkyIslandPointText
    {
        ...
        internal static string Lore(string key)
        {
            switch (key)
            {
                ...
                case "Search_S4": return L10n.T(
                    "观星镜被守卫占着。清掉他们、校准镜片，白天黑夜都能找回群岛的星图。",
                ...
                case "Search_A_02": return L10n.T(
                    "码头的等候名单上划掉了大半的名字。最后一行是浮舟的字：『梯田那头的蛙鸣池有人捎信回来，说晴禾的种植记录还泡在水边。』",
                ...
                case "Search_C_02": return L10n.T(
                    ...
                    "Arrows are cut into the ridge posts, all pointing at the Hanging Root Wood: 'The day the wind beacon jammed, the wood folk moved in behind the root ring. If you're hurt, find Miantai. She prices her moss remedy by how bad the wound is.'");
                case "Search_D_02": return L10n.T(
                ...
                case "Search_E_02": return L10n.T(
                    ...
                    "A fresh row of notches runs along the rail, as if someone were counting the days: 'The night both lamps were lit, the wind climbed up out of the cloud sea. Before it draws its eye shut, a ring of light shows at its feet. See the light, get out of the ring. Can't make it? Get behind solid rock.'");
                case "Search_F_02": return L10n.T(
                    "池底压着一张被水泡软的拓本，只看得清半条航线，终点圈着「听雨洞」。另一半在折翎手里，他说旧信和航路图都齐了才肯坐下来谈。池边的石缝里挂着一团团蛙卵：风灾那年，蛙鸣池的青蛙逃到了这里。",
                ...
                default: return L10n.T(
                    "旧木牌上记录着岛民的一天：有人等信，有人修灯，有人把空船再系紧一点。",
                    "An old board records a day on the islands: someone waiting for a letter, someone mending a lamp, someone tying an empty boat a little tighter.");
            }
        }
    }
}

...
export const CATEGORIES: WikiCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {
        path: '/equipment/sky-island-lords-gear',
        zh: '岛主装备',
        en: 'Island Lord Gear',
        icon: 'eq-sky-island-lords-gear',
        blurbZh: '悬根猎首与穗镰身上的两套，倒下必留一件',
        blurbEn: 'Two sets worn by Sky Island lords; each fall leaves one piece',
        tagZh: '天空岛',
        tagEn: 'Sky Island',
      },
      {
        path: '/equipment/sky-island-chiefs-gear',
        zh: '头目装备',
        en: 'Island Chief Gear',
        icon: 'eq-sky-island-chiefs-gear',
        blurbZh: '七位头目各穿一件，倒下三到四成留下',
        blurbEn: 'One piece per Sky Island chief; a 30–40% drop',
        tagZh: '天空岛',
        tagEn: 'Sky Island',
      },
    ],

...
::: warning
In Infinite Hell it doesn't advance the wave, doesn't drop a crate and doesn't feed the cash pool, so the only payout left is relic souls plus that egg/stone roll. Unless you're banking a bloodline, walk around it and spend the time pushing waves.
:::

...
::: tip
Thunder Set shines in dense multi-enemy waves (Infinite Hell, Zombie Mode normal waves). Frost Set is better for 1v1 boss control. Pick based on the run type.
:::

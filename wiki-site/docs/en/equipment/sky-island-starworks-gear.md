...
::: tip
Only found on Sky Island's chief and island lord: they wear the full set every raid, and when they fall they keep **just one piece** by weight, which takes one slot in the loot box; the rest of the box is whatever they were carrying.
:::
...
- **Starbrass Visor Helm** (helmet): quality 5, Head Armor +3, durability 70, item ID 500086
- **Starfurnace Harness** (body armor): quality 5, Body Armor +3, durability 100, item ID 500087
...
**Starworks pair** (any two of the Starbrass Visor Helm / Starfurnace Harness / Starfurnace Pack worn at once):
- At Fuzhou's dock workbench, recipes that need **two or more Brass Scrap** take **1 less**; the crafting panel shows the reduced count for what you are wearing.
- Only what you wear at the moment you craft counts; take a piece off and the price goes back up.

**Stargazer's Lens Helm** (worn, with durability left):
- **Stand still for 2 seconds** on the isles and every living enemy within 40 m gets a ring of star marks at its feet for 4 seconds; then an 8-second cooldown.
- At zero durability it stops working until repaired.
...
::: tip
Both show a boss health bar and name. First kills of the Foreman and the Stargazer are recorded in the archipelago journal's overview.
:::

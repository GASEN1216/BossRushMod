...
- **Cooldown**: 10s / **Stamina**: 14
- Summons **5 undead** around you (2.5m radius, 100 HP each)
- Join your faction, fight for you, don't drop loot on death
...
::: tip
If it drops from a Blue Boss loot crate, it follows the same search flow as other items in that crate.
:::

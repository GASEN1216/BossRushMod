...
::: tip
Keep eggs in the outer layer of your bag or stash. The hatch page can now find eggs tucked inside containers too, but the outer layer is easier to count.
:::

See the PetNest page.
...
- **Stardust**: an occasional extra from wind crystal clusters from the boardwalk onward, more often at night (22:00–06:00) and at the overlook once the telescope is calibrated; Qinglan charms, cloudmoss veils and the Starfall Overlook lamp need it

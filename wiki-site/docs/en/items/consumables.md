...
- **Source**: occasionally found in Sky Islands crates; also cooked at Qinghe's stove from Greenear Sheaf ×4 + Driftwood ×1
...
- **Effect**: restores 40 health (cannot be used at full health)
...
- **Effect**: on the Qinglan isles, a warm light follows you overhead for about 4 minutes of game time; while it burns the night chill does not build and slowly fades. Using another only refills the timer
...
- **Effect**: on the Qinglan isles, about 5 minutes of game time immune to wind chill, with +15% stamina recovery
...
- **Effect**: for this raid, +10% max health (only the newly added portion is topped up) and +10% stamina recovery

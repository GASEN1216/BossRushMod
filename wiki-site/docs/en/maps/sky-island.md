...
::: tip
A region only counts as visited once you actually walk into it — eyeing it from the far bridgehead does not light it up on the map.
:::

::: tip
The objective on the status line at the top of the screen changes with your progress. If the next step isn't obvious, open the map first, then follow the physical bridges you have already unlocked. The HUD also tells you how many scavenging points are left this run and whether you're carrying a contract.
:::

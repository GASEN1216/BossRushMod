...
- **Galebreaker Rangers** — they lead the roaming groups on the Windsong Boardwalk and at the Bell Court. Tougher, faster to react, and recognisable at a glance by their size and colour, so the main-line objectives are no longer just another sweep. The three chiefs on the return relay platforms, Galebreaker Ranger (Chaser / Stalker / Warden), are their leaders — see below.
...
- **Galebreaker Ranger (Warden)** (chief) — leads the group on the relay platform of the Windsong Boardwalk return shortcut (K3), wears the Galebreaker Hood, and is just as hostile to the scavengers. It lunges only once and its line stays lit longest, the easiest of the three to read — learn the lunge on it first; shoot its hood through and the line stays lit twice as long. It drops that **Galebreaker Hood** 40% of the time. See "Island Chief Gear" for the seven chief pieces and what they do.
...
**The Windeater's echo**: once you have rung the Homecoming Bell and beaten the Windeater, the twin-beacon gate device on Windsong Boardwalk offers "Call the wind" — that wind still remembers the place.

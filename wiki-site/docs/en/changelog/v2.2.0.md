...
::: tip
Update: the Frost and Thunder sets below (4 pieces) are **obtainable in a later version** — they drop from the "???" boss and Storm Zone bosses, or can be bought from Dingdang's Shop at affinity level 6. The 5 P0 weapons are still a developer preview.
:::

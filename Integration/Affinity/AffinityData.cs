...
namespace BossRush
{
    ...
    public class AffinityData
    {
        ...
        /// <summary>
        /// 上次赠送礼物的反应类型（0=普通, 1=喜欢, -1=不喜欢）
        /// </summary>
        public int lastGiftReaction;
        
        /// <summary>
        /// 上次对话的游戏日期（用于每日对话限制）
        /// </summary>
        public int lastChatDay;
        ...
        /// 5级故事对话是否已触发（持久化）
        /// </summary>
        public bool hasTriggeredStory5;
    ...
    /// </summary>
    [Serializable]
    public class AllAffinityData
    {
        /// <summary>
        /// 所有NPC的好感度数据列表
        /// </summary>
        public List<AffinityData> npcDataList;
        
        /// <summary>
        /// 创建空容器
        /// </summary>
        public AllAffinityData()
        {
            npcDataList = new List<AffinityData>();
        }
    }
}

// ============================================================================
// BrickStoneConfig.cs - 砖石物品配置
// ============================================================================
// 模块说明：
//   定义砖石物品的配置常量和初始化逻辑
//   砖石是一种消耗品，使用后可召唤场景中的哥布林NPC跑向玩家
// ============================================================================
...
namespace BossRush
{
    ...
    /// 砖石物品配置
    /// </summary>
    public static class BrickStoneConfig
    {
        // ============================================================================
        // 物品基础配置
        // ============================================================================
        ...
        /// </summary>
        public const int TYPE_ID = 500015;
        
        /// <summary>
        /// AssetBundle 名称
        /// </summary>
        public const string BUNDLE_NAME = "brick_stone";
        
        /// <summary>
        /// 图标资源名称
        /// </summary>
        public const string ICON_NAME = "BrickStone";
        ...
        /// 物品本地化键
        /// </summary>
        public const string LOC_KEY_DISPLAY = "BossRush_BrickStone";
        
        /// <summary>
        /// 物品显示名称（中文）
        /// </summary>
        public const string DISPLAY_NAME_CN = "砖石";
        
        /// <summary>
        /// 物品显示名称（英文）
        /// </summary>
        public const string DISPLAY_NAME_EN = "Brick Stone";
        ...
        /// 库存存档键
        /// </summary>
        public const string STOCK_SAVE_KEY = "BossRush_BrickStone_Stock";
        ...
        public static void ConfigureItem(Item item)
        {
            ...
            try
            {
                ...
                // 添加使用行为组件（如果没有）
                BrickStoneUsage usage = item.GetComponent<BrickStoneUsage>();
                if (usage == null)
                {
                    usage = item.gameObject.AddComponent<BrickStoneUsage>();
                }
                ...
                ModBehaviour.DevLog("[BrickStoneConfig] 砖石物品配置完成");
            }
            catch (Exception e)
            {
                ModBehaviour.DevLog("[BrickStoneConfig] 配置物品失败: " + e.Message);
            }
        }
        ...
        public static void RegisterConfigurator()
        {
            ...
            ModBehaviour.DevLog("[BrickStoneConfig] 已注册物品配置器");
        }
    }
}

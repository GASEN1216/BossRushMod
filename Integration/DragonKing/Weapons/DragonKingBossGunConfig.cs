...
namespace BossRush
{
    public static class DragonKingBossGunConfig
    {
        ...
        public const string WeaponDescCN = "龙息枪的残骸重铸成铳，枪管里总带着余火。" +
            ...
            "\n<color=#FF4500>【龙铳覆式】</color>换口径会改变射速、伤害、弹匣、射程和弹道。" +
        ...
        public const string WeaponDescEN = "Reforged from Dragon Breath wreckage. Embers linger in the barrel." +
            ...
            "\n<color=#FF4500>[Dragon Cannon Override]</color> Caliber changes fire rate, damage, capacity, range and projectile behavior." +
